	    ...
	    _createClass(App, [{
	        ...
	        value: function setMessage() {
	            if (this.textInput !== null) {
	                _superagent2.default.post('/api/message').send({ message: this.textInput.value }).end(function (err, res) {
	                    console.log('sent!');
	                });
	            }
	        }
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Text...', ref: function ref(_ref) {
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            { onClick: this.setMessage, className: 'btn btn-primary', type: 'button' },
	                            'Set text'
	                        )
	                    )
	                )
